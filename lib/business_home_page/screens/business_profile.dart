...
//                                 decoration: BoxDecoration(
//                                   color:
//                                       const Color.fromARGB(255, 216, 196, 180),
//                                   borderRadius: BorderRadius.circular(10),
//                                 ),
//                                 child: const Padding(
//                                   padding: EdgeInsets.all(8.0),
...
//                       ),
//                       const SizedBox(height: 20),
//                       _buildInfoTile("Name", _name, Icons.person, context,
//                           (val) {
//                         setState(() {
//                           _name = val;
//                         });
...
//                       const SizedBox(height: 10),
//                       _buildInfoTile(
//                           "Industry Type", _industryType, Icons.work, context,
//                           (val) {
//                         setState(() {
//                           _industryType = val;
//                         });
...
//                       const SizedBox(height: 10),
//                       _buildInfoTile(
//                           "City", _city, Icons.location_city, context, (val) {
//                         setState(() {
//                           _city = val;
//                         });
//                       }),
