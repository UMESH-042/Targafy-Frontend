...
//   // Add a flag to track whether a refresh is in progress
//   bool _isRefreshing = false;

//   @override
//   void initState() {
//     super.initState();
//     // Call the function with the provided businessId only if not already refreshing
...
//                           // Reset the flag after refreshing is completed
//                           _isRefreshing = false;
//                         },
...
//                                       final user =
//                                           userRequestList.userRequestList![index];
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: ListView.builder(
                                    shrinkWrap: true,
                                    physics: const NeverScrollableScrollPhysics(),
                                    itemCount: userRequestList.userRequestList!.length,
                                    itemBuilder: (context, index) {
                                      final user = userRequestList.userRequestList![index];
                                      return RequestTile(
                                        date: DateTime.parse(user.date),
                                        name: user.name,
                                        contactNumber: user.contactNumber,
