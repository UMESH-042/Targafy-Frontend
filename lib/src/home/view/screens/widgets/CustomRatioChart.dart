...
//     List<List<dynamic>> ratioData = _calculateRatio(formattedFirstData, formattedSecondData);
//     bool isPercentage = false;
...
//   double roundUp(double value) {
//     int exponent = (log(value) / log(10)).floor();
...
//     double minBenchmarkValue = double.infinity;
//     for (var value in benchmark) {
//       double benchmarkValue = double.parse(value);
//       if (benchmarkValue < minBenchmarkValue) {
//         minBenchmarkValue = benchmarkValue;
//       }
//     }
//     return minBenchmarkValue;
//   }
...
class CustomRatioChart extends StatelessWidget {
  ...
  DateTime _findMaxDate(
    ...
    int daysInMonth =
        DateTime(maxDate.year, maxDate.month + 1, 0).day; // End of the month
    return DateTime(maxDate.year, maxDate.month, daysInMonth);
  }
